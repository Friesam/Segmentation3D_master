...
using System.Collections;
    ...
    public class LoadingOverlay : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            this.SegMaterial = this.gameObject.GetComponent<Renderer>().material;
            this.from_color = this.SegMaterial.color;
            this.to_color = this.SegMaterial.color;
        }
        ...
        void Update()
        {
            ...
            this.SegMaterial.color = Color.Lerp(this.from_color, this.to_color, this.fade_timer);
            if (this.SegMaterial.color == this.to_color)
            {
                this.fading = false;
                this.fade_timer = 0;
            }
        ...
        public void FadeOut()
        {
            ...
            if (this.to_color != this.SegMaterial.color)
            {
                this.fading = true;
            }
        }
